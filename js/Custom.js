...
function giftOpen() {
    jQuery("section.gift").on("click", function () {
        ...
        var pt1 = document.getElementsByClassName('pt-1');
        var pt2 = document.getElementsByClassName('pt-2');
        var pt3 = document.getElementsByClassName('pt-3');
        var pt4 = document.getElementsByClassName('pt-4');
        var pt5 = document.getElementsByClassName('pt-5');

        pt5[0].play();

        pt1[0].classList.add('hiddenew');

        
        pt3[0].classList.remove("hiddenew");
        pt4[0].classList.remove("hiddenew");
                            ...
                            $("#reindeer").animate(
                                ...
                                function () {
                                    $(".message").typed({
                                        strings: [
                                            "<<< Merry Christmas >>>",
                                            "Chúc bạn và những người yêu quý có một mùa Giáng Sinh tràn ngập tình thương và hạnh phúc. Mừng Giáng Sinh và Chúc năm mới đầy niềm vui và thành công! :) Nghe nhạc zui zẻ nha!!!",
                                        ],
                                        typeSpeed: 5,
                                        startDelay: 100,
                                        backSpeed: 5,
